...
def schema_upgrades() -> None:
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), server_default=sa.text('now()'), nullable=False),
